angular.module('sbFlotModule', []).
    ...
    directive('sbFlotMultipleAxesLineChart', function () {
        return {
            restrict: 'E',
            replace: true,
            compile: function (element) {
    ...
    directive('sbFlotMovingLineChart', function () {
        return {
            restrict: 'E',
            replace: true,
            compile: function (element) {
                ...
                return function (scope, element) {
                    ...
                    var maximum = element.outerWidth() / 2 || 300;
    ...
    directive('sbFlotBarChart', function () {
        return {
            restrict: 'E',
            replace: true,
            compile: function (element) {
                ...
                return function (scope, element) {
                    ...
                    $.plot(element, [barData], barOptions);
